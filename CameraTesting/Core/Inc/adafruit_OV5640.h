/*
 *	OV5640 Adafruit Camera Breakout Board I2C Driver Header
 *
...
#ifndef INC_ADAFRUIT_OV5640_H_
#define INC_ADAFRUIT_OV5640_H_
...
#define OV5640_REG_DLY							   0xFFFFU

/*
 * Register Data in the form {register, data} that is written at
 * specific stages or when specific outputs are needed
 */

static const uint16_t DataOnInit[][2] = {
	...
	{OV5640_POLARITY_CTRL, 0x21},
	{0x4713, 0x02},  // jpg mode select
	{OV5640_ISP_CONTROL01, 0x83},  // turn color matrix, awb and SDE
	// sys reset
	{OV5640_SYSREM_RESET00, 0x00}, // enable all blocks
	{OV5640_SYSREM_RESET02, 0x1C}, // reset jfifo, sfifo, jpg, fmux, avg
	// clock enable
	{0x3004, 0xFF},
