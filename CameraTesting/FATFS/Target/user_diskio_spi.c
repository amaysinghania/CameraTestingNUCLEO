...
#define FCLK_FAST() { MODIFY_REG(SD_SPI_HANDLE.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_64); }	/* Set SCLK = fast, approx 1.1 MBits/s */
...
)
{
	...
	if (!wait_ready(1000)) return 0;		/* Wait for card ready */
